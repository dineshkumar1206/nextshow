...
import HomeStreamingForm from "./HomeStreamingForm";

import { FaEdit } from "react-icons/fa";
import {
  deleteHomeStreamContent,
  fetchAllHomeStream,
  resetHomeStreamState,
} from "../../../../redux/HomeContentSlice/HomeStreamSlice";

const HomeStreamingSection = () => {
  ...
  const handleDelete = (id) => {
    if (window.confirm("Are you sure you want to delete this home content?")) {
      NProgress.start();
      dispatch(deleteHomeStreamContent(id));
    }
  };
...
export default HomeStreamingSection;
